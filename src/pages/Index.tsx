  ...
  const features = [
    {
      ...
      description:
        "Connect with verified doctors through secure video calls from anywhere",
      color: "bg-blue-50",
    },
    {
      ...
      description:
        "Multiple consultation modes including voice calls and instant messaging",
      color: "bg-green-50",
    },
    {
      ...
      description:
        "Get instant health guidance and symptom analysis with our multilingual AI bot",
      color: "bg-purple-50",
    },
    {
    ...
    },
    {
      ...
      title: "Local Network",
      description:
        "Find doctors and pharmacies in your area with distance tracking",
      color: "bg-red-50",
    },
    {
      ...
      description:
        "Your health records stored securely with offline access capability",
      color: "bg-indigo-50",
    },
  ];
      ...
      <section className="bg-white text-black sm:bg-gradient-to-r sm:from-blue-600 sm:to-green-600 sm:text-white py-20">
        <div className="hidden sm:flex flex-col max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className=" text-center">
            ...
            >
              Connect with verified doctors, find medicines, and get AI-powered
              health guidance - all in your local language
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Addressing real healthcare challenges faced by patients, doctors,
              and pharmacies in rural and urban areas
            </p>
          </div>
      ...
      <section id="features" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need for comprehensive healthcare management in one
              platform
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`${feature.color} p-4 rounded-lg inline-block mb-6`}
                >
                  {feature.icon}
                </div>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive healthcare solutions for patients, healthcare
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-blue-300 transition-colors"
              >
                ...
                <button
                  className={`w-full ${service.color} text-white py-3 px-6 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Simple steps to get started with healthcare at your fingertips
            </p>
          </div>
            ...
            {[
              {
                step: "1",
                title: "Register",
                desc: "Sign up with your phone number and choose your preferred language",
                icon: <Users className="w-8 h-8" />,
              },
              {
                step: "2",
                title: "Search",
                desc: "Find doctors by specialization or search for medicines nearby",
                icon: <MapPin className="w-8 h-8" />,
              },
              {
                step: "3",
                title: "Connect",
                desc: "Book consultations via video, call, or chat based on your preference",
                icon: <Video className="w-8 h-8" />,
              },
              {
                step: "4",
                title: "Get Care",
                desc: "Receive prescriptions, health guidance, and follow-up support",
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-green-100 max-w-3xl mx-auto">
            Join thousands of users who are already experiencing better
            healthcare through our platform
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button
              whileHover={{ scale: 1.05 }}
