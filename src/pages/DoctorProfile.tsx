...
const DoctorProfile = () => {
  ...
  const doctor = {
    ...
    about:
      "Dr. Rajesh Kumar is an experienced General Physician with expertise in treating common ailments, preventive care, and chronic disease management. He has been serving the Nabha community for over 8 years.",
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6">
            ...
            <p className="text-gray-700">
              <strong>Type:</strong>{" "}
              {
                consultationOptions.find((opt) => opt.type === consultationType)
                  ?.label
              }
            </p>
            <p className="text-gray-700">
              <strong>Fee:</strong> ₹{doctor.consultationFee[consultationType]}
            </p>
          </div>
          <p className="text-sm text-gray-600 mb-6">
            You will receive a confirmation SMS and the doctor will contact you
